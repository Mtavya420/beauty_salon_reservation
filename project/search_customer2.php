...
<?php
    ...
    $sql2 = "SELECT distinct datetime, C.name, style_menu,C.telephone_number FROM reservation R, designer D, customer C WHERE C.name='$name'and cid=C.id and did=D.id" ;
