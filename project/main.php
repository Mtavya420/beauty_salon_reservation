...
//client reservation button event
function reservation(){
	window.open('reservation.php', '등록하기', "width=350,height=350,toolbar=no,location=yes,status=no,menubar=no, scrollbars=no,resizable=no,left=150,top=150");
}
 ...
 <div id="beauty_salon">
	 ...
	 <p> 미용실 예약에 앞서 고객이 아닌 분들은 등록을 해주시기 바랍니다.</p>
		...
		<div style="padding-bottom: 5px;" >
			...
			<button style="border-width:0px; margin-right: 5px;" onClick="reservation()">미용실 예약
			</button>
